/*
 * -*- c -*- JASSPA MicroEmacs - www.jasspa.com efunc.h - Command name
 * defintions. Copyright (C) 1988-2009 JASSPA (www.jasspa.com) This
...
#define comIgnore     0xff	/* Ignore this command wrt state &
				 * hilighting */
#define comSelStart   0x01	/* Start hilighting - remove fix and make
				 * active */
#define comSelStop    0x02	/* If active but not fixed then stop, make 
				 * inactive */
...
#define comSelDelFix  0x40	/* Stop hilighting if fixed, does not
				 * remove the fix */
...
/*
 * initialize the command name lookup hash table. This is horrid but
 * greatly improves macro language performance without increasing start-up 
 * time. 
 */
...
meCommand      *cmdHash[cmdHashSize] = {
    ...
    &__cmdArray[CK_SAVSBUF], NULL, &__cmdArray[CK_EXENCMD],
	&__cmdArray[CK_INSTAB], NULL,
    NULL, NULL, NULL, NULL, &__cmdArray[CK_DELWBAK],
    &__cmdArray[CK_REDREGY], &__cmdArray[CK_HIWRD], &__cmdArray[CK_GOFNC],
	NULL, NULL,
    ...
    &__cmdArray[CK_BUFPOS], NULL, NULL, &__cmdArray[CK_ONLYWND],
	&__cmdArray[CK_REDFILE],
    &__cmdArray[CK_PRTBUF], &__cmdArray[CK_SWNDH], &__cmdArray[CK_CRTCLBK],
	&__cmdArray[CK_APPBUF], NULL,
    NULL, &__cmdArray[CK_IPIPWRT], NULL, &__cmdArray[CK_GOTOPOS],
	&__cmdArray[CK_SETMRK],
    ...
    &__cmdArray[CK_WRPWRD], &__cmdArray[CK_ENDMAC],
	&__cmdArray[CK_SHOWCUR], NULL, NULL,
    &__cmdArray[CK_DELBAK], NULL, NULL, &__cmdArray[CK_TRNLINE],
	&__cmdArray[CK_STRREP],
    ...
    &__cmdArray[CK_WDWDPTH], &__cmdArray[CK_DELSBUF], &__cmdArray[CK_UNDO],
	NULL, NULL,
    NULL, NULL, NULL, NULL, NULL,
    NULL, NULL, NULL, NULL, NULL,
    &__cmdArray[CK_GOBOL], &__cmdArray[CK_DELFOR], NULL,
	&__cmdArray[CK_TRNSKEY], &__cmdArray[CK_NAMBUF],
    NULL, NULL, NULL, NULL, &__cmdArray[CK_ABOUT],
    &__cmdArray[CK_LCLBIND], &__cmdArray[CK_REYANK], NULL, NULL, NULL,
    &__cmdArray[CK_DOTAB], &__cmdArray[CK_GOEOP], &__cmdArray[CK_BAKLIN],
	&__cmdArray[CK_BISRCH], &__cmdArray[CK_SETCRY],
    NULL, &__cmdArray[CK_BAKWND], &__cmdArray[CK_WRTMSG], NULL, NULL,
    &__cmdArray[CK_PKSCRN], &__cmdArray[CK_GOEOL], NULL, NULL, NULL,
    &__cmdArray[CK_DELTAB], &__cmdArray[CK_OSDBIND], NULL, NULL,
	&__cmdArray[CK_WRTBUF],
    ...
    &__cmdArray[CK_FORLIN], NULL, NULL, &__cmdArray[CK_HILIGHT],
	&__cmdArray[CK_SORTLNS],
    ...
    NULL, NULL, NULL, NULL, NULL,
    &__cmdArray[CK_PRTCOL], &__cmdArray[CK_UNSET], &__cmdArray[CK_SCLPRV],
	NULL, NULL,
    ...
    &__cmdArray[CK_DESCVAR], &__cmdArray[CK_MCRQURY], NULL, NULL,
	&__cmdArray[CK_NBUFMOD],
    ...
    NULL, &__cmdArray[CK_IPIPKLL], &__cmdArray[CK_CMPBUF], NULL,
	&__cmdArray[CK_PPPWND],
    &__cmdArray[CK_GOAMRK], &__cmdArray[CK_ADDDICT], NULL, NULL,
	&__cmdArray[CK_HUNFOR],
    ...
    &__cmdArray[CK_EXEMAC], &__cmdArray[CK_LSTBUF], NULL, NULL,
	&__cmdArray[CK_SPLLWRD],
    NULL, NULL, &__cmdArray[CK_CMDWAIT], &__cmdArray[CK_SYSTEM],
	&__cmdArray[CK_NXTWND],
    NULL, NULL, NULL, NULL, NULL,
    ...
    NULL, &__cmdArray[CK_PIPCMD], &__cmdArray[CK_QREP],
	&__cmdArray[CK_HELP], NULL,
    NULL, NULL, &__cmdArray[CK_MRKREGY], &__cmdArray[CK_RCASLOW], NULL,
    &__cmdArray[CK_EXESTR], NULL, NULL, NULL, NULL,
    &__cmdArray[CK_CPYREG], &__cmdArray[CK_ADDCOL], &__cmdArray[CK_NAMMAC],
	NULL, NULL,
    &__cmdArray[CK_OPNLIN], NULL, NULL, NULL, &__cmdArray[CK_DELBUF],
    NULL, NULL, &__cmdArray[CK_MOVRWND], NULL, NULL,
    NULL, NULL, NULL, NULL, NULL,
    &__cmdArray[CK_INSSTR], NULL, &__cmdArray[CK_EXABBREV], NULL,
	&__cmdArray[CK_EXEBUF],
    NULL, NULL, &__cmdArray[CK_DEFMAC], &__cmdArray[CK_MLBIND],
	&__cmdArray[CK_FRMDPTH],
    ...
    &__cmdArray[CK_EXIT], &__cmdArray[CK_STCHRMK], NULL,
	&__cmdArray[CK_DESCKEY], NULL,
    &__cmdArray[CK_IPIPCMD], NULL, &__cmdArray[CK_FISRCH],
	&__cmdArray[CK_OSDUNBD], &__cmdArray[CK_SFNDFIL],
