/*
 * -*- c -*- JASSPA MicroEmacs - www.jasspa.com emode.h - Define
 * interface to the modes. Copyright (C) 1998-2009 JASSPA
...
#endif				/* _WIN32 */
#ifdef _DOS
	meModeMask(MDLF) | meModeMask(MDCTRLZ) |
#endif				/* _DOS */
	meModeMask(MDFENCE) |
	meModeMask(MDMAGIC) | meModeMask(MDTAB) | meModeMask(MDUNDO)
};
...
meMode          modeLineDraw = {
	...
	meModeMask(MDTAB) |
	meModeMask(MDTIME) |
	meModeMask(MDUNDO) | meModeMask(MDVIEW) | meModeMask(MDWRAP)
};
