/*
 * -*- c -*- JASSPA MicroEmacs - www.jasspa.com evar.h - Variable,
 * function and derivative definitions. Copyright (C) 1988-2009 JASSPA
...
#if 0
/*
 * list of recognized user directive names As of ME'04 this list is
 * nolonger used, see docmd in exec.c 
 */
#define	DEFVAR(s,v)		/* NULL */
#define	DEFFUN(v,s,t)
