/*
 * -*- c -*- JASSPA MicroEmacs - www.jasspa.com eprint.h - Printer
 * definitions. Copyright (C) 1998-2009 JASSPA (www.jasspa.com) This
...
/*
 * Local printer types include mePD_INT 0x01 Integer data mePD_STR 0x00
 * String data mePD_WIN 0x02 Autosave items for windows into Microemacs
 * registry. 
 */
...
typedef struct {
    ...
    int             pNoHeaderLines;	/* Number of lines needed for
					 * header */
    int             pNoFooterLines;	/* Number of lines needed for
					 * footer */
