/*
 * -*- c -*- JASSPA MicroEmacs - www.jasspa.com key.c - Key and name
 * table porcessing. Copyright (C) 1991-2009 JASSPA (www.jasspa.com)
...
decode_key(meUShort ocode, meUInt * arg)
{
  ...
  try_again:
     ...
     * change the key to be the 1st prefix without the Alt, e.g.  A-space
     * -> esc space and then look this up 
     */
    if (code & ME_ALT) {
#if MEOPT_OSD
