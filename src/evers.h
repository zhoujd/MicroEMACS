/*
 * -*- c -*- JASSPA MicroEmacs - www.jasspa.com evers.h - The build
 * version definition. Copyright (C) 1992-2009 JASSPA (www.jasspa.com)
 ...
 * RELEASE OF THE BUILD AND ARE USED AS A REFERENCE POINT WHEN PROBLEMS
 * OCCUR. THESE VALUES ARE NOT INTENDED TO REPRESENT THE BUILD DATE OF
 * THE SOFTWARE AND MUST NOT BE MODIFIED AS SUCH 
 */
